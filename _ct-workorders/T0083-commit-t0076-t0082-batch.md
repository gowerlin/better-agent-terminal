...
### 產出摘要
分 3 筆 commit 提交 T0076~T0082 累積變更：

1. `c9c3936` feat(tower): T0076 — BMad workspace refresh + BUG-017~020 修復
   - 1 file, +34/-47
2. `32e3cf4` feat(tower): T0077/T0078/T0079/T0081/T0082 — UI 調整 + VS Code 開啟功能
   - 13 files, +212/-16
3. `09e50df` chore(tower): T0076~T0083 工單文件 + bug tracker 更新
   - 21 files, +1637/-11

共 35 檔案變更，working tree clean。未 push。
