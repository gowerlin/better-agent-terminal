...
| PLAN-032 | Setup Wizard Error UX Overhaul（Stepper awaiting-input + error mapping framework） | 🟡 medium | 🔄 IN_PROGRESS | [PLAN-032](PLAN-032-wizard-error-ux-overhaul.md) |
...
| ID | 標題 | 完成時間 | 連結 |
|----|------|---------|------|
| _（無熱區；PLAN-034 等已歸檔 _archive/plans/）_ | | | |
