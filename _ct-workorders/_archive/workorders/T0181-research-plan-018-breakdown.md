...
- **Hash**：`4822dbd`
- **Message**：`docs(ct): T0181 — PLAN-018 拆分研究報告（3 張下游工單完整規格）`
- **Files**：3 files changed, 847 insertions(+), 1 deletion(-)
  - `_ct-workorders/_report-t0181-plan-018-breakdown.md`（新增）
  - `_ct-workorders/PLAN-018-remote-security-hardening.md`（更新「相關工單」段）
  - `_ct-workorders/T0181-research-plan-018-breakdown.md`（新增本工單 + 回報區填寫）
